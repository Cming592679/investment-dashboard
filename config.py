...
FUNDS = {
    ...
    "019671": {
        ...
        "specials": {
            "XBI": {"name": "美股生物科技ETF", "note": "全球创新药情绪风向标，加息周期利空"},
        },
        "exit_thresholds": {
            "rsi_overbought": 75, "rsi_oversold": 25,
            "drop_red": -5, "drop_yellow": -3,
...
LEADING_INDICATORS = {
    "019633": {
        ...
        "美国对华设备管制升级风险【②外部催化剂】": {
            ...
            "update_cycle": "季度（复核BIS公告+联邦公报，确认管制是否升级）",
            "last_updated": "2026-08-31",
        },
    },
    ...
    # ═══ 创新药 · 港股生物科技（真实持仓：019671 广发中证香港创新药 QDII） ═══
    # 瓶颈原型：⑧Big Pharma买单 ⑨政策/医保 ②单源卡脖子（重磅管线）
    "019671": {
        "创新药出海 BD/对外授权金额【⑧Big Pharma买单】": {
            "value": "2026H1 中国创新药对外授权(BD/License-out)交易额创历史新高，多个首付款超$10亿大单",
            "trend": "up",
        ...
        "重磅临床数据读出/新药获批【②单源卡脖子】": {
            ...
            "update_cycle": "季度（复核临床数据读出/获批进展，确认关键节点日期）",
            "last_updated": "2026-09-17",
        },
    },
}
...
KEY_DATES = {
    "019633": [
        ...
        {"date": date(2026, 8, 26), "event": "NVDA Q2 财报(CapEx风向标)", "importance": "critical",
         "result": "8/26美股盘后发布：Q2营收$962.21亿(+106% YoY/+18% QoQ)超预期($922亿)；数据中心$890亿(+117%)超预期($859亿)；Non-GAAP EPS $2.22(+120%)超预期；Non-GAAP毛利率75%；2028财年营收指引再增70%。判定：大幅超预期——AI Capex确定性强化，设备/存储链需求端无虞"},
        ...
        {"date": date(2026, 8, 28), "event": "拓荆科技 Q2 财报(预计)", "importance": "high",
         "result": "8/28已发布：H1营收29.13亿(+49.06%)，归母净利13.43亿；Q2单季营收18.0亿(+44.56% YoY/+61.85% QoQ)，归母净利7.72亿(+220.08% YoY/+35.32% QoQ)，扣非2.65亿(+21.42%)，毛利率40.58%(+1.76pct)。判定：符合预期偏正面——先进制程放量带动薄膜沉积/三维集成订单，设备景气延续；但归母与扣非差距大（非经常性损益贡献），利润质量需留意"},
    ...
    "CPO": [
        ...
        {"date": date(2026, 8, 26), "event": "NVDA Q2 财报", "importance": "critical",
         "result": "8/26美股盘后发布：Q2营收$962.21亿(+106%)、数据中心$890亿(+117%)双双超预期，Non-GAAP EPS $2.22(+120%)，2028财年营收指引再增70%。判定：大幅超预期——1.6T/CPO与光模块需求确定性增强，关注Rubin放量节奏"},
        ...
        {"date": date(2026, 8, 28), "event": "Marvell Q2 FY2027 财报(DSP芯片)", "importance": "critical",
         "result": "8/27美股盘后：Q2营收$27.39亿(+37% YoY/+13% QoQ)创历史新高，超指引中点$3900万；Non-GAAP EPS $0.94超预期($0.93)，营收超共识$2.71B→$2.74B，GAAP毛利率53.1%，指引上调。判定：营收/EPS双超预期但盘后跌8.2%($221.63)——DSP需求确认，市场分歧在增速质量与估值"},
    ...
    "021528": [
        ...
        {"date": date(2026, 8, 26), "event": "NVDA Q2 财报(服务器需求)", "importance": "high",
         "result": "8/26美股盘后发布：Q2营收$962.21亿(+106%)超预期，数据中心$890亿(+117%)，超大规模客户营收$487.1亿。判定：大幅超预期——AI服务器出货与高速交换机需求强劲，高速PCB/CCL景气延续"},
        ...
        {"date": date(2026, 8, 28), "event": "胜宏科技 Q2 财报(拟8/28披露，预告+171~182%)", "importance": "high",
         "result": "8/27晚披露：H1营收116.29亿(+28.77%)，归母净利28.57亿(+33.30%)，扣非24.18亿；Q2单季营收61.1亿(+29.49%)，归母净利15.68亿(+28.29%，环比+21%)；毛利率降至~32-33%(下滑)，应收账款体量较大。注意：7/13预告+171~182%(75-78亿)与实际严重不符，需甄别口径。判定：AI PCB景气延续但增速与毛利率承压、预告偏差大——中性偏谨慎"},
    ...
    "025856": [
        ...
        {"date": date(2026, 8, 27), "event": "四方股份 Q2 财报(拟8/27披露)", "importance": "high",
         "result": "8/27已发布：H1营收44.82亿(+11.49%)，归母净利5.14亿(+8%)，EPS 0.62，拟10派4.8元。判定：符合预期——较许继(-34%)/特变(-20%)明显稳健，继保/配电业务韧性"},
        ...
        {"date": date(2026, 8, 30), "event": "国电南瑞 Q2 财报(预计) ⚠", "importance": "critical",
         "result": "8/27已发布：H1营收277.67亿(+14.54%)，归母净利30.73亿(+4.08%)，扣非29.25亿；Q2单季营收182.03亿(+18.6%/环比+90.3%)，归母净利23.51亿(+3.49%，环比+226%)；经营现金流同比大幅下滑，财务费用转正，新签订单可观、海外空间广阔。判定：符合预期但增收不增利——订单面乐观，利润与现金流质量需关注"},
    ...
    "020608": [
        ...
        {"date": date(2026, 8, 26), "event": "NVDA Q2 财报(机器人平台)", "importance": "high",
         "result": "8/26美股盘后发布：NVDA整体大幅超预期（营收$962亿/+106%），机器人平台（Isaac/Thor）持续推进。判定：超预期——财报落地后机器人交易冻结解除，但机器人板块弹性仍待Optimus量产催化，低吸按RSI/布林条件执行"},
        ...
        {"date": date(2026, 8, 27), "event": "绿的谐波 Q2 财报 ⚠(拟8/27披露)", "importance": "critical",
         "result": "8/27已发布：H1营收3.49亿(+38.64%)，归母净利7010.92万(+31.25%)，扣非5816.63万，经营现金流-1741.57万；同步宣布拟赴港股IPO。判定：符合预期——谐波出货延续但利润弹性一般，港股IPO为新增催化"},
    ...
    "STORAGE": [
        ...
        {"date": date(2026, 8, 26), "event": "NVDA Q2 财报(HBM需求)", "importance": "critical",
         "result": "8/26美股盘后发布：Q2营收$962.21亿(+106%)超预期，数据中心$890亿(+117%)——GPU出货与HBM配置量跟随放量，存储需求端确定性强化。判定：大幅超预期——HBM/DRAM涨价周期延续"},
        ...
        {"date": date(2026, 8, 28), "event": "北京君正 Q2 财报(拟8/28披露，预告+431~531%)", "importance": "high",
         "result": "8/28已发布：H1营收39.57亿(+75.95%)，归母净利11.98亿(+489.59%)，扣非11.66亿；Q2单季营收23.97亿(+101.66% YoY/+53.71% QoQ)，归母净利8.79亿(+579.96% YoY/+175.44% QoQ)。符合预告+431~531%区间。判定：大幅超预期——存储涨价+车规/消费复苏，存储链景气兑现"},
...
CYCLE_ASSESSMENTS = {
    ...
    "019671": {
        "stage": "early",
        "label": "港股创新药复苏早期（BD出海+融资回暖）",
        "note": "【创新药】港股创新药从2021年高点回撤70%+后，2024-2025年因BD出海爆发+美联储降息预期回暖。当前处于估值修复早期：BD交易额创新高、18A融资回暖，但国内医保降价压力仍在。核心变量：BD出海持续性、美联储利率方向、医保谈判。注意：18A属高久期资产，对利率敏感，加息周期估值承压。",
        "risk": "yellow",
    },
}
...
CYCLE_COUNTER_HYPOTHESIS = {
    ...
    "019671": "如果美联储重启加息→港股18A创新药(高久期资产)估值承压，当前'复苏早期'判断需下调；反之若降息持续则加速修复",
}
