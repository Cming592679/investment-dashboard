...
LEADING_INDICATORS = {
    "019633": {
        "北方华创合同负债 QoQ【⑥设备景气先行】": {
            "value": "2026H1末合同负债约¥42亿（与2025年末持平，较2025Q3高点回落）；H1营收201.61亿(+24.9%)、归母净利33.70亿(+5.05%)，毛利率下滑+费用刚性挤压利润",
            "trend": "down",
            "note": "【⑥设备订单先行】合同负债=Fab预付款=设备订单领先6-12月。从2023年83.2亿→2025年42.9亿→2026H1约42亿，连续回落至营收占比约11%；Q2财报(8/25)验证收入高增但利润增速(+5%)大幅落后——订单先行指标走弱需重点关注，若H2不回升则国产替代逻辑需复核",
            "update_cycle": "季报后（4/8/10月底）",
            "last_updated": "2026-08-25",
        },
        "中芯国际 Capex/折旧比【⑧Fab扩产意愿】": {
            "value": "Q2 Capex=$18.36亿(+17.5% QoQ)，折旧摊销=$12.12亿(+11.4% QoQ) → Capex/折旧≈1.5x（维持激进扩张）",
            "trend": "up",
            "note": "【⑧Fab扩产→设备订单】中芯国际是国内最大Fab，Capex/折旧>1.5=激进扩产。Q2财报(8/15)已验证：营收首破$30亿(+36.1% YoY/+20% QoQ)、产能利用率93.7%、Capex环比+17.5%——扩产意愿延续，直接转化为北方华创/中微/拓荆的订单",
            "update_cycle": "季报后",
    ...
    "025856": {
        "国网/南网年度投资计划【⑧单一大客户】": {
            "value": "H1固投1290亿(+37% YoY)、物资招标>2500亿(+17%)；国网2026前4批特高压设备招标累计约¥293亿（换流阀87亿/29.8%），南瑞33.8%/许继26.4%/特变11.8%；8月已启动第四次变电设备招标共485包(750kV-10kV)",
            "trend": "up",
            "note": "【⑧巨头依赖】国网H1投资进度超预期(+37%→远超年初+8%计划)。特高压设备招标密集落地（前4批约293亿），8月第四批变电设备485包启动——特高压+配电网双轮驱动。若H2维持节奏→全年固投可能上修至7000亿+",
        ...
        "新能源装机增速→电网消纳压力": {
            "value": "截至7月底全国累计装机40.8亿kW(+11%)；1-7月新增1.94亿kW（风电4707万+太阳能8615万千瓦，合计占近七成）；7月单月光伏新增14.08GW(+27.5% YoY/+12.8% MoM)",
            "trend": "up",
            "note": "新能源装机>电网消纳能力=弃风弃光=倒逼电网投资。1-7月风光新增占比近七成，7月光伏环比回升——装机增速越快→电网改造越紧迫→设备需求越确定。煤电占比已降至32%(2010年>60%)",
    ...
    "STORAGE": {
        "DRAM合约价 QoQ【②寡头定价→③产能售罄】": {
            "value": "Q3 PC DRAM合约价预期+15~20% QoQ（TrendForce 6月底上调）、Q4 +3~8%；服务器DRAM Q3约+13~18%趋缓；传统DRAM Q2 +58~63%、Q3E +40~50%(Jefferies)。涨幅减速但绝对值仍在涨",
            "trend": "up",
            "note": "【②→③核心指标】DRAM合约价=全球存储周期温度计。PC/消费端回补带动Q3预期上调，服务器端从Q2的~50%放缓至Q3的13~18%=周期从加速进入匀速，但绝对值仍在涨。关键：涨幅减速≠下跌。若连续2季涨幅<5%→警惕见顶",
        ...
        "NAND Flash合约价 QoQ【②寡头→库存周期】": {
            "value": "Q2 NAND合约价+70~75%（SanDisk实际），Q3预期+10~15%，Q4预期+5~10%（QLC外溢，全品类上涨）。涨幅逐季收窄但仍在涨",
            "trend": "up",
            "note": "【②库存周期】NAND比DRAM周期更短(6-12月)。Q2暴涨70%+后Q3/Q4逐季回落至+10~15%/+5~10%=供给在追赶，但仍在上涨区间。若NAND先于DRAM转跌→是DRAM周期的早期预警。铠侠/WDC合并影响供给格局",
...
KEY_DATES = {
    "019633": [
        ...
        {"date": date(2026, 8, 21), "event": "SEMI 7月 Billings", "importance": "critical",
         "result": "7月北美半导体设备出货约$26亿(+27.6% YoY/+11.8% MoM)，创今年新高，连续10个月站上$20亿；设备订单景气延续，AI驱动先进逻辑/存储扩产。判定：符合预期偏正面，设备链需求端无忧"},
        {"date": date(2026, 8, 25), "event": "中微公司 Q2 财报(预计)", "importance": "high",
         "result": "8/25已发布：H1营收66.91亿(+34.89%)，归母净利28.25亿(+300.22%)；Q2单季营收37.76亿(+35.48% YoY/+29.55% QoQ)，归母净利18.95亿(+382.32% YoY/+103.63% QoQ)，刻蚀先进工艺量产推进。判定：符合预期偏正面——设备景气延续"},
        {"date": date(2026, 8, 26), "event": "北方华创 Q2 财报(预计) ⚠", "importance": "critical",
         "result": "8/25晚提前发布：H1营收201.61亿(+24.9%)，归母净利33.70亿(+5.05%)，扣非33.41亿(+5.02%)；期末合同负债约¥42亿（与2025年末持平，较2025Q3高点回落），毛利率下滑+费用刚性挤压利润。判定：收入稳健但利润增速大幅落后，设备订单先行指标（合同负债）连续走弱需关注"},
    ...
    "CPO": [
        ...
        {"date": date(2026, 8, 24), "event": "中际旭创 半年报(预计) ⚠", "importance": "critical",
         "result": "8/21晚提前发布：H1营收417.78亿(+182.49%)，归母净利136.51亿(+241.70%)，扣非130.92亿(+229.32%)，经营现金流18.0亿(-44.08%)，拟10派12元；800G/1.6T高端光模块需求显著增长，1.6T硅光模块进入规模放量。判定：大幅超预期——AI算力光模块景气兑现，CPO需求端确定性强化"},
        {"date": date(2026, 8, 25), "event": "新易盛 Q2 财报(预计)", "importance": "high",
         "result": "8/25已发布：H1营收209.1亿(+100.34%)，归母净利约75亿(+90.98%)；Q2营收125.72亿(+96.9% YoY/+50.78% QoQ)，归母净利47.49亿(+100.4% YoY/+70.83% QoQ)，1.6T光模块放量。判定：超预期——CPO景气延续"},
        {"date": date(2026, 8, 25), "event": "天孚通信 Q2 财报(预计)", "importance": "high",
         "result": "8/18已发布：H1营收28.28亿(+15.15%)，归母净利12.04亿(+33.92%)，研发投入+55%；个别物料短缺影响有源光器件交付。判定：中性偏正面——光器件景气但短期受物料约束"},
    ...
    "021528": [
        ...
        {"date": date(2026, 8, 25), "event": "沪电股份 Q2 财报(预计)", "importance": "high",
         "result": "8/25已发布：H1营收136.89亿(+61.17%)，归母净利29.23亿(+73.72%)，高速交换机+AI PCB放量。判定：符合预期偏正面"},
        {"date": date(2026, 8, 25), "event": "深南电路 半年报(预计)", "importance": "critical",
         "result": "8/25已披露半年报（归母净利约21-23亿/+54.4%~69.1%，扣非20.8-22.8亿/+64.4%~80.2%，与预告区间一致；详细数值以正式披露为准）；AI算力+封装基板驱动，无锡高多层AI PCB扩产推进。判定：符合预期"},
        {"date": date(2026, 8, 25), "event": "东山精密 Q2 财报(预计)", "importance": "high",
         "result": "8/25已发布：H1营收277.98亿(+63.95%)，归母净利29.57亿(+290.09%)，Q2单季归母净利18.47亿；AI PCB+光模块双轮驱动。判定：超预期"},
        {"date": date(2026, 8, 28), "event": "胜宏科技 Q2 财报(拟8/28披露，预告+171~182%)", "importance": "high"},
        {"date": date(2026, 8, 25), "event": "生益科技 Q2 财报(CCL上游)", "importance": "high",
         "result": "8/14已发布：H1营收190.26亿(+50.05%)，归母净利32.87亿(+130.42%)，Q2单季环比+83.82%；AI高速CCL放量。判定：超预期"},
    ...
    "015789": [
        ...
        {"date": date(2026, 8, 25), "event": "中国卫星 Q2 财报(预计)", "importance": "high",
         "result": "8/18已发布：H1营收18.85亿(+42.72%)，归母净利3456.58万，同比扭亏为盈。判定：正面但体量仍小"},
        {"date": date(2026, 8, 25), "event": "航天电子 Q2 财报(预计)", "importance": "high",
         "result": "8/25已发布：H1营收45.30亿(-22.19%)，归母净利4058.92万(-76.63%)，同比大幅下滑（预告区间3600-4300万，实际处于区间内）。判定：明显不及预期——军工电子景气承压"},
        {"date": date(2026, 8, 25), "event": "中科星图 Q2 财报(预计)", "importance": "high",
         "result": "8/25已发布：H1营收5.14亿(-61.85%)，归母净利-3.19亿，由盈转亏（同比约-508%）。判定：重大恶化——需复核015789军工电子映射逻辑"},
    ...
    "025856": [
        ...
        {"date": date(2026, 8, 15), "event": "7月新能源装机数据", "importance": "high",
         "result": "国家能源局7月调度会(8/17)：上半年可再生能源装机24.55亿kW(占60.7%)，风光约19.5亿kW；1-6月新增1.17亿kW(占全部新增73.9%)。全国7月单月新增装机未单独披露"},
        {"date": date(2026, 8, 20), "event": "国网 7月物资招标数据(预计)", "importance": "high",
         "result": "7/21国网公布特高压第三次设备/材料及输变电第三次装置性材料中标（风范股份等企业合计中标超¥1.5亿级）；8月启动第四次变电设备(含电缆)招标共485包（750kV-10kV），电网设备投资节奏延续。判定：符合预期——Q3招标密集，电网设备需求稳定"},
        {"date": date(2026, 8, 25), "event": "许继电气 Q2 财报(预计)", "importance": "high",
         "result": "8/25已发布：H1营收65.25亿(+1.21%)，归母净利4.16亿(-34.40%)，Q2环比+175%；特高压+海外订单蓄势。判定：利润承压但环比改善"},
        {"date": date(2026, 8, 25), "event": "中国西电 Q2 财报(预计)", "importance": "high",
         "result": "8/25已发布：H1营收122.13亿(+8.07%)，归母净利6.88亿(+15.03%)，扣非7.36亿(+20.74%)。判定：符合预期"},
        {"date": date(2026, 8, 27), "event": "四方股份 Q2 财报(拟8/27披露)", "importance": "high"},
        {"date": date(2026, 8, 25), "event": "特变电工 Q2 财报(预计)", "importance": "high",
         "result": "8/25已发布：H1营收565.85亿(+16.91%)，归母净利25.52亿(-19.84%)，扣非26.73亿；Q2营收环比+26.4%，公允价值变动损失拖累利润。判定：利润承压、经营面回暖"},
    ...
    "020608": [
        ...
        {"date": date(2026, 8, 25), "event": "恒立液压 Q2 财报(丝杠进度)", "importance": "high",
         "result": "8/25已发布：H1营收68.33亿(+32%)，归母净利14.36亿(+0.5%)，Q2营收36.23亿/归母净利7.84亿；丝杠/导轨/电缸批量投产，墨西哥放量。判定：符合预期——丝杠兑现进度是关键"},
        {"date": date(2026, 8, 27), "event": "绿的谐波 Q2 财报 ⚠(拟8/27披露)", "importance": "critical"},
        {"date": date(2026, 8, 25), "event": "金力永磁 Q2 财报(磁材出货)", "importance": "high",
         "result": "8/25已发布：H1营收46.49亿(+32.57%)，归母净利4.62亿(+51.58%)；机器人磁材出货放量。判定：符合预期偏正面"},
        {"date": date(2026, 8, 25), "event": "日发精机 Q2 财报(磨床出货)", "importance": "high",
         "result": "8/25已发布：H1营收3.10亿(-56.71%，口径调整)，归母净利5012万，扭亏为盈；丝杠磨床+航空装备双线。判定：扭亏为正面信号"},
    ...
    "STORAGE": [
        ...
        {"date": date(2026, 8, 25), "event": "兆易创新 Q2 财报(预计)", "importance": "high",
         "result": "8/18已发布：H1营收115.66亿(+178.67%)，归母净利68.57亿(+1091.50%)，扣非48.83亿；现货AI存储量价齐升。判定：大幅超预期"},
        {"date": date(2026, 8, 28), "event": "北京君正 Q2 财报(拟8/28披露，预告+431~531%)", "importance": "high"},
